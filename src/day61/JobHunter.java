...
public class JobHunter {
    public static void main(String[] args) {
        ...
        System.out.println("myFavJobs after sorting = " + myFavJobs);
        Collections.sort(myFavJobs, Comparator.reverseOrder());
        System.out.println("myFavJobs after reverse comparing logic = " + myFavJobs);
        Collections.sort(myFavJobs, Comparator.reverseOrder());
        System.out.println("myFavJobs after reverse comparing logic again = " + myFavJobs);
        Collections.sort(myFavJobs);
        System.out.println("myFavJobs after sorting = " + myFavJobs);
    }
}
