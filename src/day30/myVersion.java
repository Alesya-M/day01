...
//            for (int i = 0; i < cars[x].length()-1; i++) {
//                String car = cars[x];
...
//        System.out.println("Car maker is "+eachCarSplitted[0]+" Car Model is "+ eachCarSplitted);
        for(String eachCar : cars){
            if( eachCar.startsWith("Audi") ){
                //System.out.println("eachCar = " + eachCar);
                String[] eachCarSplitted = eachCar.split("-");
                System.out.println("Car maker is "+eachCarSplitted[0]+" Car Model is "+ eachCarSplitted[1]);
            }
        }
         int countCars=0;
        for(String twoCharacters : cars){

                //System.out.println("eachCar = " + eachCar);
                String[] eachCarSplitted = twoCharacters.split("-");
        ...
        System.out.println("Count: "+countCars);
